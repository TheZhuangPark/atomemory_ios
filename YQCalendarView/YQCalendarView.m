...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    self.backgroundColor = [UIColor colorWithRed:255 / 255.0 green:255 / 255.0 blue:255 / 255.0 alpha:0.35];
    
    self.layer.masksToBounds = YES;
    self.layer.cornerRadius=kScreenWidth/12;
    [self SetUp];
...
-(void)SetUp{
   ...
   /* self.backgroundColor = [UIColor colorWithRed:255 / 255.0 green:255 / 255.0 blue:255 / 255.0 alpha:0.6];
    ...
    self.layer.masksToBounds = YES;
    self.layer.cornerRadius=kScreenWidth/36;*/
