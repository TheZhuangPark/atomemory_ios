...
@interface DAnimateViewController ()
...
@implementation DAnimateViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [_rootViewController viewWillAppear:YES];
...
- (void)viewWillDisappear:(BOOL)animated {
   ...
   /* NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    ...
    UIViewController *obj = [NSKeyedUnarchiver unarchiveObjectWithData:objData];
   // [obj viewDidLoad];
...
- (void)btnclick {
    DPushViewController *vc = [[DPushViewController alloc] init];
...
- (void)viewDidLoad {
    ...
    // 添加控制器
    DPersonalViewController *leftVc = [[DPersonalViewController alloc] init];
